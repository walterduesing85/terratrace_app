...
//       await ref.watch(userProvider).getCollaboratorIDs(userId);
//   print("👥 Collaborators of current user: $collaboratorIDs");
...
//       final isCollaborator = collaboratorIDs.contains(user.userID);
//       if (isCollaborator) {
//         print("✅ User ${user.userID} is a collaborator.");
//       } else {
//         print("❌ User ${user.userID} is NOT a collaborator.");
//       }
//       return isCollaborator;
//     }).map((user) {
//       final projectRole = user.projects?[currentProjectName];
...
//             userCard.userMail.toLowerCase().contains(queryLower);
//       }).toList();
//       print("🔍 Filtered userCards based on search: ${filtered.length}");
//       yield filtered;
//     } else {
//       yield userCards;
//     }
